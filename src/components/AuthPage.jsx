  ...
  return (
    <div
      style={{
        ...
        background: darkMode ? "#181A1F" : "#f8f9fa",
        color: darkMode ? "#E1E3E8" : "#333",
        padding: "1rem",
        textAlign: "center",
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          right: "1rem",
          padding: "0.5rem 1rem",
          background: darkMode ? "#E1E3E8" : "#181A1F",
          color: darkMode ? "#181A1F" : "#E1E3E8",
          border: "none",
          borderRadius: "6px",
          cursor: "pointer",
          fontSize: "0.9rem",
      ...
      {user ? (
        <>
          <h1 style={{ marginBottom: "0.5rem" }}>Welcome, {user.displayName}</h1>
          <p style={{ marginBottom: "2rem" }}>You are logged in and ready to start.</p>
          <button
        ...
        <>
          <h1 style={{ marginBottom: "0.5rem" }}>Welcome to the Assessment</h1>
